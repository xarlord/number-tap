...
class ProfileRepositoryTest {
    ...
    // ── awardTapCoins / awardComboBonus / updateMissionProgress / claimMission ──
    // These methods were removed from ProfileRepository in #240 (dead code —
    // production exclusively uses the equivalent methods in RetentionLogic).
    // The corresponding tests live in RetentionLogicTest.kt.
